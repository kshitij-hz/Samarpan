		...
		@if($seniorCitizens)
			...
			<div class="card">
				...
				<div class="col-md-4 pull-right">
					<a href="{{url('admin/search_citizens')}}" class="btn btn-primary waves-effect">Start a new search <i class="fa fa-search"></i></a>
				</div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-10">
						...
						<div class="card-block">
							...
							<a href="{{url('admin/edit', $senior->user_id)}}" class="btn btn-primary pull-xs-right">Edit</a>
							<a href="{{url('admin/view', $senior->user_id)}}" class="btn btn-primary pull-xs-right">Full Profile</a>
							@if($senior->cv)
							<a href="{{ url('admin/cvdownload', $senior->id) }}" class="btn btn-primary pull-xs-right">Resume</a>
							@endif
						</div>
						<!--/.Card content-->
					</div>
