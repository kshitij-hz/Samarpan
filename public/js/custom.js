...
$(document).ready(function(){
    ...
    var same2 = '<div class="md-form"><input name="company" type="text" class="form-control" placeholder="Organization/Society/Company name" id="company"></div><select name="rank" id="rank" class="mdb-select"><option value="" disabled selected>Choose Grade Rank</option><option value="Group A">Group A or Grade Rank 1</option><option value="Group B">Group B or Grade Rank 2</option><option value="Group C">Group C or Grade Rank 3</option><option value="Group D">Group D or Grade Rank 4</option></select></div><div class="md-form"><input name="position" id="position" type="text" class="form-control" placeholder="Enter Position"></div>';
